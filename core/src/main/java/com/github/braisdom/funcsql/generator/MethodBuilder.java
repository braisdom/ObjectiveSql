...
class MethodBuilder {
//
//  static MethodBuilder newMethod(JavacTreeMaker treeMaker, APTUtils typeNode) {
...
//
//  private MethodBuilder(JavacTreeMaker treeMaker, APTUtils typeNode) {
...
//  }
//
//  JCMethodDecl buildWith(APTUtils node) {
...
//  }
//
//  static JCVariableDecl createParameter(APTUtils typeNode, Class<?> paramType, String name) {
//    return createParameter(typeNode, genTypeRef(typeNode, paramType.getName()), name);
//  }
//
//  static JCVariableDecl createParameter(APTUtils typeNode, JCExpression paramType, String name) {
