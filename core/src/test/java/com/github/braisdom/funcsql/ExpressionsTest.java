...
import com.github.braisdom.funcsql.sql.Expressions;
...
public class ExpressionsTest {
    ...
    private static class DefaultSQLContext implements SQLContext {
    ...
    public void testPlus() {
        ...
        String sqlPart = plusExpression.toSql(new DefaultSQLContext());
