...
import com.github.braisdom.jds.ast.expr.FieldAccessExpr;
...
public class FieldAccessExprMetaModel extends ExpressionMetaModel {
    ...
    FieldAccessExprMetaModel(Optional<BaseNodeMetaModel> superBaseNodeMetaModel) {
        super(superBaseNodeMetaModel, FieldAccessExpr.class, "FieldAccessExpr", "com.github.braisdom.jds.ast.expr", false, false);
    }
