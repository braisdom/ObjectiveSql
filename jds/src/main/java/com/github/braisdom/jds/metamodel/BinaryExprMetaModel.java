...
import com.github.braisdom.jds.ast.expr.BinaryExpr;
...
public class BinaryExprMetaModel extends ExpressionMetaModel {
    ...
    BinaryExprMetaModel(Optional<BaseNodeMetaModel> superBaseNodeMetaModel) {
        super(superBaseNodeMetaModel, BinaryExpr.class, "BinaryExpr", "com.github.braisdom.jds.ast.expr", false, false);
    }
