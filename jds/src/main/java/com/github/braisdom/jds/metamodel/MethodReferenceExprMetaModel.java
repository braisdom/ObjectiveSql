...
import com.github.braisdom.jds.ast.expr.MethodReferenceExpr;
...
public class MethodReferenceExprMetaModel extends ExpressionMetaModel {
    ...
    MethodReferenceExprMetaModel(Optional<BaseNodeMetaModel> superBaseNodeMetaModel) {
        super(superBaseNodeMetaModel, MethodReferenceExpr.class, "MethodReferenceExpr", "com.github.braisdom.jds.ast.expr", false, false);
    }
