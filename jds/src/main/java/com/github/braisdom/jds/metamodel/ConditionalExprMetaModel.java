...
import com.github.braisdom.jds.ast.expr.ConditionalExpr;
...
public class ConditionalExprMetaModel extends ExpressionMetaModel {
    ...
    ConditionalExprMetaModel(Optional<BaseNodeMetaModel> superBaseNodeMetaModel) {
        super(superBaseNodeMetaModel, ConditionalExpr.class, "ConditionalExpr", "com.github.braisdom.jds.ast.expr", false, false);
    }
