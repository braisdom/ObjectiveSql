...
import com.github.braisdom.jds.ast.expr.MethodCallExpr;
...
public class MethodCallExprMetaModel extends ExpressionMetaModel {
    ...
    MethodCallExprMetaModel(Optional<BaseNodeMetaModel> superBaseNodeMetaModel) {
        super(superBaseNodeMetaModel, MethodCallExpr.class, "MethodCallExpr", "com.github.braisdom.jds.ast.expr", false, false);
    }
