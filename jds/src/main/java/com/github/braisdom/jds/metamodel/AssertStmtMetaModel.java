...
import com.github.braisdom.jds.ast.stmt.AssertStmt;
...
public class AssertStmtMetaModel extends StatementMetaModel {
    ...
    AssertStmtMetaModel(Optional<BaseNodeMetaModel> superBaseNodeMetaModel) {
        super(superBaseNodeMetaModel, AssertStmt.class, "AssertStmt", "com.github.braisdom.jds.ast.stmt", false, false);
    }
