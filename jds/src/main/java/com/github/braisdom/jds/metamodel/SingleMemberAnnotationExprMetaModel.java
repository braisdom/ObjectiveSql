...
import com.github.braisdom.jds.ast.expr.SingleMemberAnnotationExpr;
...
public class SingleMemberAnnotationExprMetaModel extends AnnotationExprMetaModel {
    ...
    SingleMemberAnnotationExprMetaModel(Optional<BaseNodeMetaModel> superBaseNodeMetaModel) {
        super(superBaseNodeMetaModel, SingleMemberAnnotationExpr.class, "SingleMemberAnnotationExpr", "com.github.braisdom.jds.ast.expr", false, false);
    }
