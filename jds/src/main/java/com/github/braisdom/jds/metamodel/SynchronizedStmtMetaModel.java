...
import com.github.braisdom.jds.ast.stmt.SynchronizedStmt;
...
public class SynchronizedStmtMetaModel extends StatementMetaModel {
    ...
    SynchronizedStmtMetaModel(Optional<BaseNodeMetaModel> superBaseNodeMetaModel) {
        super(superBaseNodeMetaModel, SynchronizedStmt.class, "SynchronizedStmt", "com.github.braisdom.jds.ast.stmt", false, false);
    }
