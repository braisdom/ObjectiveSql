...
import com.github.braisdom.jds.ast.expr.ObjectCreationExpr;
...
public class ObjectCreationExprMetaModel extends ExpressionMetaModel {
    ...
    ObjectCreationExprMetaModel(Optional<BaseNodeMetaModel> superBaseNodeMetaModel) {
        super(superBaseNodeMetaModel, ObjectCreationExpr.class, "ObjectCreationExpr", "com.github.braisdom.jds.ast.expr", false, false);
    }
