...
import com.github.braisdom.jds.ast.modules.ModuleUsesDirective;
...
public class ModuleUsesDirectiveMetaModel extends ModuleDirectiveMetaModel {
    ...
    ModuleUsesDirectiveMetaModel(Optional<BaseNodeMetaModel> superBaseNodeMetaModel) {
        super(superBaseNodeMetaModel, ModuleUsesDirective.class, "ModuleUsesDirective", "com.github.braisdom.jds.ast.modules", false, false);
    }
