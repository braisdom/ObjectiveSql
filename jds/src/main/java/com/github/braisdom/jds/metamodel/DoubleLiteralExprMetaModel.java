...
import com.github.braisdom.jds.ast.expr.DoubleLiteralExpr;
...
public class DoubleLiteralExprMetaModel extends LiteralStringValueExprMetaModel {
    ...
    DoubleLiteralExprMetaModel(Optional<BaseNodeMetaModel> superBaseNodeMetaModel) {
        super(superBaseNodeMetaModel, DoubleLiteralExpr.class, "DoubleLiteralExpr", "com.github.braisdom.jds.ast.expr", false, false);
    }
}
