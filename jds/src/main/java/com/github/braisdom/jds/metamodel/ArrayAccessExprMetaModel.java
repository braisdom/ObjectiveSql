...
import com.github.braisdom.jds.ast.expr.ArrayAccessExpr;
...
public class ArrayAccessExprMetaModel extends ExpressionMetaModel {
    ...
    ArrayAccessExprMetaModel(Optional<BaseNodeMetaModel> superBaseNodeMetaModel) {
        super(superBaseNodeMetaModel, ArrayAccessExpr.class, "ArrayAccessExpr", "com.github.braisdom.jds.ast.expr", false, false);
    }
