...
import com.github.braisdom.jds.ast.expr.MarkerAnnotationExpr;
...
public class MarkerAnnotationExprMetaModel extends AnnotationExprMetaModel {
    ...
    MarkerAnnotationExprMetaModel(Optional<BaseNodeMetaModel> superBaseNodeMetaModel) {
        super(superBaseNodeMetaModel, MarkerAnnotationExpr.class, "MarkerAnnotationExpr", "com.github.braisdom.jds.ast.expr", false, false);
    }
}
