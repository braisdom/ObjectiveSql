...
import com.github.braisdom.jds.ast.nodeTypes.NodeWithMembers;
import com.github.braisdom.jds.ast.nodeTypes.NodeWithSimpleName;
...
import com.github.braisdom.jds.ast.nodeTypes.modifiers.NodeWithStrictfpModifier;
...
import com.github.braisdom.jds.metamodel.TypeDeclarationMetaModel;
...
public abstract class TypeDeclaration<T extends TypeDeclaration<?>> extends BodyDeclaration<T> implements NodeWithSimpleName<T>, NodeWithJavadoc<T>, NodeWithMembers<T>, NodeWithAccessModifiers<T>, NodeWithStaticModifier<T>, NodeWithStrictfpModifier<T> {
     ...
     * @see com.github.braisdom.jds.ast.stmt.LocalClassDeclarationStmt
     */
