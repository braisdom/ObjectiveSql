...
import com.github.braisdom.jds.ast.type.WildcardType;
...
public class WildcardTypeMetaModel extends TypeMetaModel {
    ...
    WildcardTypeMetaModel(Optional<BaseNodeMetaModel> superBaseNodeMetaModel) {
        super(superBaseNodeMetaModel, WildcardType.class, "WildcardType", "com.github.braisdom.jds.ast.type", false, false);
    }
