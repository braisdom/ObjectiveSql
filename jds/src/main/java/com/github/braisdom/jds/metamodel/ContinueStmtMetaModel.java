...
import com.github.braisdom.jds.ast.stmt.ContinueStmt;
...
public class ContinueStmtMetaModel extends StatementMetaModel {
    ...
    ContinueStmtMetaModel(Optional<BaseNodeMetaModel> superBaseNodeMetaModel) {
        super(superBaseNodeMetaModel, ContinueStmt.class, "ContinueStmt", "com.github.braisdom.jds.ast.stmt", false, false);
    }
