...
import com.github.braisdom.jds.ast.stmt.SwitchStmt;
...
public class SwitchStmtMetaModel extends StatementMetaModel {
    ...
    SwitchStmtMetaModel(Optional<BaseNodeMetaModel> superBaseNodeMetaModel) {
        super(superBaseNodeMetaModel, SwitchStmt.class, "SwitchStmt", "com.github.braisdom.jds.ast.stmt", false, false);
    }
