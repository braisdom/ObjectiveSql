...
import com.github.braisdom.jds.ast.expr.SwitchExpr;
...
public class SwitchExprMetaModel extends ExpressionMetaModel {
    ...
    SwitchExprMetaModel(Optional<BaseNodeMetaModel> superBaseNodeMetaModel) {
        super(superBaseNodeMetaModel, SwitchExpr.class, "SwitchExpr", "com.github.braisdom.jds.ast.expr", false, false);
    }
