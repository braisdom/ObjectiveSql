...
import com.github.braisdom.jds.ast.expr.EnclosedExpr;
...
public class EnclosedExprMetaModel extends ExpressionMetaModel {
    ...
    EnclosedExprMetaModel(Optional<BaseNodeMetaModel> superBaseNodeMetaModel) {
        super(superBaseNodeMetaModel, EnclosedExpr.class, "EnclosedExpr", "com.github.braisdom.jds.ast.expr", false, false);
    }
