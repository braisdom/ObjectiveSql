...
import com.github.braisdom.jds.ast.body.EnumConstantDeclaration;
...
public class EnumConstantDeclarationMetaModel extends BodyDeclarationMetaModel {
    ...
    EnumConstantDeclarationMetaModel(Optional<BaseNodeMetaModel> superBaseNodeMetaModel) {
        super(superBaseNodeMetaModel, EnumConstantDeclaration.class, "EnumConstantDeclaration", "com.github.braisdom.jds.ast.body", false, false);
    }
