...
import com.github.braisdom.jds.ast.expr.LiteralExpr;
...
public class LiteralExprMetaModel extends ExpressionMetaModel {
    ...
    LiteralExprMetaModel(Optional<BaseNodeMetaModel> superBaseNodeMetaModel) {
        super(superBaseNodeMetaModel, LiteralExpr.class, "LiteralExpr", "com.github.braisdom.jds.ast.expr", true, false);
    }
