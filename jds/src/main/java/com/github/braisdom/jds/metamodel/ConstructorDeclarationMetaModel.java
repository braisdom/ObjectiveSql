...
import com.github.braisdom.jds.ast.body.ConstructorDeclaration;
...
public class ConstructorDeclarationMetaModel extends CallableDeclarationMetaModel {
    ...
    ConstructorDeclarationMetaModel(Optional<BaseNodeMetaModel> superBaseNodeMetaModel) {
        super(superBaseNodeMetaModel, ConstructorDeclaration.class, "ConstructorDeclaration", "com.github.braisdom.jds.ast.body", false, false);
    }
