...
import com.github.braisdom.jds.ast.expr.NormalAnnotationExpr;
...
public class NormalAnnotationExprMetaModel extends AnnotationExprMetaModel {
    ...
    NormalAnnotationExprMetaModel(Optional<BaseNodeMetaModel> superBaseNodeMetaModel) {
        super(superBaseNodeMetaModel, NormalAnnotationExpr.class, "NormalAnnotationExpr", "com.github.braisdom.jds.ast.expr", false, false);
    }
