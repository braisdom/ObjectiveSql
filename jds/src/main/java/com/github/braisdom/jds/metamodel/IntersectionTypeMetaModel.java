...
import com.github.braisdom.jds.ast.type.IntersectionType;
...
public class IntersectionTypeMetaModel extends TypeMetaModel {
    ...
    IntersectionTypeMetaModel(Optional<BaseNodeMetaModel> superBaseNodeMetaModel) {
        super(superBaseNodeMetaModel, IntersectionType.class, "IntersectionType", "com.github.braisdom.jds.ast.type", false, false);
    }
