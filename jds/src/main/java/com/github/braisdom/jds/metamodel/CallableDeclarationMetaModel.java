...
import com.github.braisdom.jds.ast.body.CallableDeclaration;
...
public class CallableDeclarationMetaModel extends BodyDeclarationMetaModel {
    ...
    CallableDeclarationMetaModel(Optional<BaseNodeMetaModel> superBaseNodeMetaModel) {
        super(superBaseNodeMetaModel, CallableDeclaration.class, "CallableDeclaration", "com.github.braisdom.jds.ast.body", true, true);
    }
