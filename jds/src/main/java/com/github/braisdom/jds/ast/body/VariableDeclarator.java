...
import com.github.braisdom.jds.ast.observer.AstObserverAdapter;
...
import com.github.braisdom.jds.metamodel.VariableDeclaratorMetaModel;
...
import com.github.braisdom.jds.resolution.declarations.ResolvedValueDeclaration;
...
public class VariableDeclarator extends Node implements NodeWithType<VariableDeclarator, Type>, NodeWithSimpleName<VariableDeclarator>, Resolvable<ResolvedValueDeclaration> {
     ...
     * @param initializer What this variable should be initialized to. An {@link com.github.braisdom.jds.ast.expr.AssignExpr}
