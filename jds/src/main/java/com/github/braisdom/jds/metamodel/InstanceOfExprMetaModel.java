...
import com.github.braisdom.jds.ast.expr.InstanceOfExpr;
...
public class InstanceOfExprMetaModel extends ExpressionMetaModel {
    ...
    InstanceOfExprMetaModel(Optional<BaseNodeMetaModel> superBaseNodeMetaModel) {
        super(superBaseNodeMetaModel, InstanceOfExpr.class, "InstanceOfExpr", "com.github.braisdom.jds.ast.expr", false, false);
    }
