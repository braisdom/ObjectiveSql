...
import com.github.braisdom.jds.ast.expr.ArrayCreationExpr;
...
public class ArrayCreationExprMetaModel extends ExpressionMetaModel {
    ...
    ArrayCreationExprMetaModel(Optional<BaseNodeMetaModel> superBaseNodeMetaModel) {
        super(superBaseNodeMetaModel, ArrayCreationExpr.class, "ArrayCreationExpr", "com.github.braisdom.jds.ast.expr", false, false);
    }
