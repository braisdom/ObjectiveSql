...
import com.github.braisdom.jds.ast.stmt.UnparsableStmt;
...
public class UnparsableStmtMetaModel extends StatementMetaModel {
    ...
    UnparsableStmtMetaModel(Optional<BaseNodeMetaModel> superBaseNodeMetaModel) {
        super(superBaseNodeMetaModel, UnparsableStmt.class, "UnparsableStmt", "com.github.braisdom.jds.ast.stmt", false, false);
    }
}
