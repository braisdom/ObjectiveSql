...
import com.github.braisdom.jds.ast.body.AnnotationMemberDeclaration;
...
public class AnnotationMemberDeclarationMetaModel extends BodyDeclarationMetaModel {
    ...
    AnnotationMemberDeclarationMetaModel(Optional<BaseNodeMetaModel> superBaseNodeMetaModel) {
        super(superBaseNodeMetaModel, AnnotationMemberDeclaration.class, "AnnotationMemberDeclaration", "com.github.braisdom.jds.ast.body", false, false);
    }
