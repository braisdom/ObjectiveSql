...
import com.github.braisdom.jds.ast.expr.MemberValuePair;
...
public class MemberValuePairMetaModel extends NodeMetaModel {
    ...
    MemberValuePairMetaModel(Optional<BaseNodeMetaModel> superBaseNodeMetaModel) {
        super(superBaseNodeMetaModel, MemberValuePair.class, "MemberValuePair", "com.github.braisdom.jds.ast.expr", false, false);
    }
