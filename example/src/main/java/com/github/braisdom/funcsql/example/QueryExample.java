...
public class QueryExample {
    ...
    public static void main(String[] args) throws SQLException {
        Database.installConnectionFactory(new SqliteConnectionFactory("query.db"));
        createTables(Database.getConnectionFactory().getConnection());

        // The User.createQuery method will be generated by DomainMode annotation
        Query<User> userQuery = User.createQuery();
        List<UserProfile> users = userQuery.limit(2).execute();
